...
public class Cls {
    ...
    public Cls(Long id, String matricola, String modello, LocalDate dataAcquisto, Boolean assistenza) {
        this.id = id;
    ...
    public String toString() {
        return "Cls [id=" + id + ", matricola=" + matricola + ", modello=" + modello + ", dataAcquisto=" + dataAcquisto
